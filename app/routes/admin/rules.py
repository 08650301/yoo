...
@admin_rules_bp.route('/api/sheets/<int:sheet_id>/conditional_rules', methods=['GET'])
...
@admin_rules_bp.route('/api/sheets/<int:sheet_id>/conditional_rules', methods=['POST'])
...
@admin_rules_bp.route('/api/conditional_rules/<int:rule_id>', methods=['PUT'])
...
@admin_rules_bp.route('/api/conditional_rules/<int:rule_id>', methods=['DELETE'])
