...
def update_field(field_id):
    try:
        ...
        field.export_word_as_label = data.get('export_word_as_label', field.export_word_as_label)
        field.export_excel_as_label = data.get('export_excel_as_label', field.export_excel_as_label)
